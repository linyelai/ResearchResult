...
<link rel="stylesheet" type="text/css" href="../js/jquery-easyui-1.5.4.2/themes/default/easyui.css">
    ...
    <script type="text/javascript" src="../js/addResearchResult.js"></script>
    <%
...
<form id="uploadImage"  method="POST" action="uploadImage.do" 
...
<input id="title" name ="title" type="text" style="width:300px" value="${result.title }">
</span>
</div>
<div class="clearStyle"><span class="researchLable">参与人</span>
<span class="researchInput">
<input id="participates" name ="participant" type="text" style="width:300px" value="${result.participant }">
</span></div>
...
<span class="researchLable"><input type="submit" value="上传"  style="margin-left:150px;" onclick="uploadImage();"/></span>
</div>
</form>

<div class="clearStyle"><span class="researchLable">
<a id="resultBtn" href="#" class="easyui-linkbutton" onclick="addResult();">新增</a></span>
<span class="researchInput"><a id="resultCancelBtn" href="#" class="easyui-linkbutton" >取消</a></span></div>
