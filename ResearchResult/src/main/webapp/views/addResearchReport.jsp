...
<div>
	...
	<div>来源：<input id="source" type="text" placeholder="输入来源"/></div>
	<div>作者：<input id="author" type="text" placeholder="输入作者"/></div>
	<div>
	    报告内容
	    <script id="editor" name="content" type="text/plain" style="width:1024px;height:300px;"></script>
	</div>
	<div><div style="margin-left: 500px;margin-right:auto;margin-top:20px;"><a id="searchReportBtn" href="#" class="easyui-linkbutton" >提交</a></div></div>
</div>
<script type="text/javascript">
    ...
    $("#searchReportBtn").click(function(){
        ...
        $.ajax({
            cache: true,
            type: "POST",
            url: BASE_PATH+"/addReport.do",
　　　　　　　　data: {
                　　　　　　　　　　"data": data,"title":title,"source":source,"author":author
            　　　　　　　　},
            async: false,
